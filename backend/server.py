...
async def get_quests(request: Request):
    ...
    can_show_a_quests = quests_since_a >= 2 and daily_a < 5
    ...
    return {
        ...
        "quests_until_a_chance": max(0, 2 - quests_since_a) if not can_show_a_quests else 0,
...
async def claim_quest_reward(quest_id: str, request: Request):
    ...
    if "a" in rewards and rewards["a"] > 0:
        ...
        can_give_a = daily_a < 5 and quests_since_a >= 2
